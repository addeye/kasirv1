...
if (isset($_POST['kode_barang'])) {
	...
	if( $key !== false) {
		...
		//jika ada data yang sesuai di keranjnag akan ditambahkan jumlah nya
		$c_qty = $_SESSION['cart'][$key]['qty'];
		$_SESSION['cart'][$key]['qty'] = $c_qty+1;

		//cek jika ada potongan dan cek jumlah barang lebi besar sama dengan minimum order potongan
